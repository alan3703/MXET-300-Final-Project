...
def getVoltage():
    ...
    ##########################################
    return Voltage_Reader # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((0, 0), "Scuttle 06, The GOAT", font=font, fill=255)
    ...
    draw.text((0, 40), "Voltage: " + str(getVoltage()), font=font, fill=255)
    #################################################
